...
(define wave
  (segments->painter
    (list
      ...
      ; 目
      (make-segment (make-vect 0.38 0.92)
                    (make-vect 0.42 0.92))
      (make-segment (make-vect 0.52 0.92)
                    (make-vect 0.48 0.92))

      ; 鼻
      (make-segment (make-vect 0.45 0.88)
                    (make-vect 0.44 0.86))
      (make-segment (make-vect 0.45 0.84)
                    (make-vect 0.44 0.86))

      (make-segment (make-vect 0.42 0.80)
                    (make-vect 0.45 0.79))
      (make-segment (make-vect 0.45 0.79)
                    (make-vect 0.48 0.80))
...
; b
; 問題の意味がわからなかった.
; use one,instead of two.でようやくわかった.
; 2つ並べていたのを1つにせよ.というだけ.
...
; テスト
; (paint wave)
; (paint (rotate180 (corner-split wave 2)))
; (paint (square-limit wave))
