...
;; ex2-79
(equ? (make-scheme-number 6) (make-scheme-number 6))
(equ? (make-scheme-number 6) (make-scheme-number 3))
...
(equ? (make-rational 2 3) (make-rational 1 2))
...
;; ex2-79
(equ? (make-complex-from-real-imag 4 3) (make-complex-from-mag-ang 5 (atan (/ 3 4))))
